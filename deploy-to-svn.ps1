...
Write-Host "  svn commit -m `"Release 1.0.6`" --username pabilo --password <tu_contraseña>"
Write-Host "========================================="
Write-Host "Recuerda que también debes crear el tag para la versión (ej. 1.0.6):"
Write-Host "  svn cp https://plugins.svn.wordpress.org/pabilo-payment-gateway-for-woocommerce/trunk https://plugins.svn.wordpress.org/pabilo-payment-gateway-for-woocommerce/tags/1.0.6 -m `"Tagging version 1.0.6`" --username pabilo --password <tu_contraseña>"
